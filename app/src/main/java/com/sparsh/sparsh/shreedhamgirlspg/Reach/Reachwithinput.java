...
import static com.sparsh.sparsh.shreedhamgirlspg.R.layout.reachwithinput;


/**
 * Created by spars on 20-12-2015.
 */
public class Reachwithinput extends Fragment implements AdapterView.OnItemSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v =inflater.inflate(reachwithinput,container,false);
        ...
        AutoCompleteTextView from = (AutoCompleteTextView) v.findViewById(R.id.autocompletetextview);
